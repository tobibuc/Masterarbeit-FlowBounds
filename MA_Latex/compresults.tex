...
% On the medium size network "gaslib-135" of the gaslib package the results were as 
...
\subsection{Relaxations of the Exact Separation Model}
...
\subsection{Acyclicity Constraints on a Cycle Base}% this is roberts code, props to him!
