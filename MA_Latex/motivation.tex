...
%TODO kann ich beweisen (sollte ich??) dass es immer eine gleichwertige azyklische loesung gibt?
...
The main question leading to this thesis was how we could improve bounds and compute flows if we assume the flow has no 
cycles. 
...
% TODO dann das MINLP beschreiben und wie sich im MINLP die Modellgroesse verkleinert
