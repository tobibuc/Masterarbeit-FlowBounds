...
\begin{algorithm}
 \begin{algorithmic}
  \Function {maxAugment}{$P$}
    ...
    \State $b'(t)\gets b'(t)-$augval%TODO
  \EndFunction
 \end{algorithmic}
...
\end{prop}
\begin{proof}
  Let $\overline{f(e)}$ be the upper bound on $e$ from the heuristic algorithm. We show that there is no feasible 
