...
\tikzset{every picture/.append style={scale=2}}%maybe better set locally?
...
\tikzset{edgeflow/.style={line width=2.5pt, #1!40, rounded corners}} %rounded corners funzt nicht?
\tikzset{arcflow/.style={->-, line width=2.5pt, #1!40, rounded corners}}
...
\tableofcontents
\newpage
\section{Introduction} \input{Einleitung}
\newpage
\subsection{Basic Notation and Definitions}\input{Definitionen}
\newpage
\input{motivation}
\newpage
\subsection{The Acyclic Flowbound Problem}\input{problem}
\subsubsection{Computational Complexity}\input{complexity}
\newpage
\section{Models and Solving Approaches}\input{models}
\newpage
\section{Implementation and Computational Results}\input{compresults}
\newpage
\section{Summary}
...
% \section{The Acyclic Flowbound Problem}\input{problem}
% \newpage
% \section{Complexity}\input{complexity}
% \newpage
