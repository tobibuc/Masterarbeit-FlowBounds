...
\end{prop}
\begin{proof}
 Let $f$ be the flow of a solution of an all-acyclic flow problem with maximum flow $f(e)$ and let $f'$ be a flow of 
the relaxation where we allow cyclic flow that is not going over $e$. 

Since $f'$ is a relaxation of $f$ we always have $f'(e)\ge f(e)$. But we have to show that also $f'(e)\le f(e)$.
